 ...
 */}                    <input name={props.AmountName} placeholder={props.amountPlaceholder} className={props.inputClassName} id={props.UserId} value= {props.AmountValue} onChange = {props.onChange}/>
